# entirely_new_project/entirely_new_project/settings.py
"""Django settings for entirely_new_project project."""
...
env = environ.FileAwareEnv(
    DEBUG=(bool, False),
    DATABASE_URL=(str, "sqlite:///entirely_new_project/db.sqlite3"),
    SECRET_KEY=(str),
    ...
    WAGTAIL_SITE_NAME=(str, "Entirely New Project"),
...
ROOT_URLCONF = "entirely_new_project.urls"
...
WSGI_APPLICATION = "entirely_new_project.wsgi.application"
